 ...
 * @author kakes
 */
public class ViewOldStudents extends javax.swing.JFrame {
    ...
    public ViewOldStudents(String id) {
        initComponents();
        collegeid=id;
         this.setLocationRelativeTo(null);
        viewstudent();
    }
     public ViewOldStudents() {
        initComponents();
        collegeid=id;
         this.setLocationRelativeTo(null);
        viewstudent();
    ...
    private void viewstudent()  {
        try {
            ...
            Dbcon db = new Dbcon();
            String sql = "select * from tbl_student where college_id='"+StaffLogin.collegeId+"' AND status='0'";
...
private void back2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_back2ActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewOldStudents.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new ViewOldStudents().setVisible(true);
            }
        });
    }
